...
- C (Intro → Intermediate)
- JavaScript (Intro → Intermediate)
- HTML / CSS (Intro → Intermediate)
- SQL (Intro → Intermediate)
- Git/GitHub (Intro → Intermediate)
...
- [Translator Language Dictionary Application - CS50 Final Project Capstone](https://github.com/VictoriaRaven/Translator-Language-Dictionary-App)
- [CS50 Other Minor Code + Translator Language Dictionary Application - CS50 Final Project Capstone](https://github.com/VictoriaRaven/CS50_Edx_Projects_Harvard)
### 2. Software Engineering & Development Projects
- Java Applications (OOP, Data Structures)
- Python Automation & GUI Projects
- C++ Algorithmic & Systems Projects
### 3. Cybersecurity & IT Projects
- IT, Linux & Networking Labs
- [Security and Cryptography](https://github.com/VictoriaRaven/Cybersecurity-Google-Coursera-UMGC)
### 4. Web & Database Projects
...
### 5. Practice, Experiments, & Learning
- Algorithm practice
...
- Security & Cryptography Basics
   - > 🔒 **Academic Integrity Note:** Repositories containing graded material or answer keys are kept private. Selected coursework may be temporarily shared **upon request** for hiring or evaluation purposes.

## Badges & Certifications
- **Upsilon Pi Epsilon (UPE)** — Honor Society (UMGC, May 9, 2025)  
- [![AEFIS Badge](https://img.shields.io/badge/HonorSocieties-UpsilonPiEpsilon-yellow)](https://gateway.aefis.net/services/exchange/api/ims/ob/images/umgc:badge:18)
   ...
   - **Issued:** [University of Maryland, Global Campus](https://gateway.aefis.net/services/exchange/api/ims/ob/issuers/umgc:institution:1) **; Time**: May 9, 2025
   - **View Badge Validation (Excludes PI):** [AEFIS Assertion Link](https://gist.github.com/VictoriaRaven/fdcac42f23b30e5ee94f8ad211077ca0)
- **CS50x - Harvardx - edx Certificate (Harvard University):** [![CS50x Certificate - HarvardX and edX](https://img.shields.io/badge/Coursera-CS50xHarvard-yellow)](https://certificates.cs50.io/8e1af2b8-c9b3-43d7-ad70-156766976cc6.pdf?size=letter)
...
## Overall
This portfolio reflects my technical skills, ethics, communication style, and compatibility with professional team environments.
If my background aligns with your team’s goals, please explore my repositories or reach out for additional materials.
- Thank you!
— **Victoria Raven**
